...
type MyImage = { id: string; url: string; prompt: string };
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (!loadingMy && myImages.length > 0) {
      const t = setTimeout(() => checkScrollButtons(), 100);
      return () => clearTimeout(t);
    }
  }, [loadingMy, myImages.length, currentIndex, checkScrollButtons]);
  ...
  const handleDownload = (image: MyImage) => {
  ...
  return (
    <div className="w-full space-y-12">
      ...
      <section>
        <h2 id="generar" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
          Generar tu tatuaje
        </h2>
      ...
      <section>
        <h2 id="galeria-privada" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
          Galería
        </h2>
          ...
          <div className="relative">
            ...
            <div className="px-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {visibleImages.map((img, index) => (
                  <Card
                    key={img.id}
                    className="overflow-hidden rounded-2xl group hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  >
            ...
            {myImages.length > IMAGES_PER_VIEW && (
              <div className="mt-4 text-center text-xs text-muted-foreground">
                ...
                {Math.min(currentIndex + IMAGES_PER_VIEW, myImages.length)} de {myImages.length}{' '}
                diseños
              </div>
            )}
          </div>
      ...
      {/* Section: Créditos & Planes */}
      <section>
        <h2 id="creditos-planes" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
          Créditos & Planes
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          <Card className="rounded-2xl border-2 border-gray-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 h-[500px] flex flex-col">
            <CardHeader className="text-center pb-4 flex-shrink-0">
              ...
              <CardDescription className="text-base">Para comenzar a explorar</CardDescription>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col px-6 pb-6">
              <div className="mb-auto">
                <div className="space-y-4 pt-8">
                  {['5 diseños por mes', 'Resolución estándar', 'Estilos básicos'].map((t) => (
          ...
          <Card className="rounded-2xl border-2 border-gray-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 h-[500px] flex flex-col">
            <CardHeader className="text-center pb-4 flex-shrink-0">
              ...
              <CardDescription className="text-base">Todo en Gratuito, además</CardDescription>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col px-6 pb-6">
              <div className="mb-auto">
                <div className="space-y-4 pt-8">
          ...
          <Card className="rounded-2xl border-2 border-gray-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 h-[500px] flex flex-col relative overflow-hidden">
            <div
              ...
              style={{
                ...
                mixBlendMode: 'normal',
                maskImage:
                  'linear-gradient(to top, rgba(0,0,0,0.9) 10%, rgba(0,0,0,0.4) 60%, rgba(0,0,0,0) 100%)',
              }}
            />
            ...
            <div className="relative z-10 flex flex-col h-full">
              <CardHeader className="text-center pb-4 flex-shrink-0">
                ...
                <CardDescription className="text-base">Todo en Pro, además</CardDescription>
                <div className="mt-2">
      ...
      <section>
        <h2 id="historial" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
      ...
      <section>
        <h2 id="ajustes" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
          Ajustes de Cuenta
        </h2>
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8">
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
                    activeSettingPanel === 'profile' ? 'rotate-180' : ''
                  }`}
                />
              </Button>
            </CardHeader>
          ...
          <Card className="rounded-2xl overflow-hidden">
            ...
            >
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8">
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
                    activeSettingPanel === 'billing' ? 'rotate-180' : ''
                  }`}
                />
              </Button>
            </CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold">
                        {billingInfo.creditsRemaining} de {billingInfo.totalCredits}
                      </p>
                    </div>
                  </div>
                  <div className="space-y-4">
          ...
          <Card className="rounded-2xl overflow-hidden">
            ...
            >
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8">
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
                    activeSettingPanel === 'preferences' ? 'rotate-180' : ''
                  }`}
                />
              </Button>
            </CardHeader>
      ...
      {/* Section: Soporte / FAQ */}
      <section>
        <h2 id="soporte-faq" className="text-3xl font-bold tracking-tight mb-6 scroll-mt-24">
          Soporte / FAQ
        </h2>
        <Card className="shadow-lg rounded-2xl">
          <CardContent className="p-6 md:p-8">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Cada generación de un set de 4 imágenes de tatuaje consume 1 crédito. Puedes
                  comprar más créditos o suscribirte para tener créditos ilimitados.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>¿Mis diseños son privados?</AccordionTrigger>
                <AccordionContent>
                  Sí, todos los diseños que generas en el dashboard son completamente privados y
                  solo tú puedes verlos en tu galería privada.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>¿Puedo cancelar mi suscripción?</AccordionTrigger>
                <AccordionContent>
                  Sí, puedes cancelar tu suscripción en cualquier momento desde la sección de
                  Facturación en tus Ajustes de Cuenta.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
